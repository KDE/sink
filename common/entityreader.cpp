...
/* QSharedPointer<Sink::ApplicationDomain::BufferAdaptor> EntityReaderUtils::getLatest(const Sink::Storage::DataStore::NamedDatabase &db, const QByteArray &uid, DomainTypeAdaptorFactoryInterface &adaptorFactory, qint64 &retrievedRevision) */
/* { */
...
/*                 retrievedRevision = Sink::Storage::DataStore::revisionFromKey(key); */
/*             } */
/*             return false; */
/*         }, */
...
/* QSharedPointer<Sink::ApplicationDomain::BufferAdaptor> EntityReaderUtils::get(const Sink::Storage::DataStore::NamedDatabase &db, const QByteArray &key, DomainTypeAdaptorFactoryInterface &adaptorFactory, qint64 &retrievedRevision) */
/* { */
/*     QSharedPointer<Sink::ApplicationDomain::BufferAdaptor> current; */
/*     db.scan(key, */
/*         [&current, &adaptorFactory, &retrievedRevision](const QByteArray &key, const QByteArray &data) -> bool { */
...
/* QSharedPointer<Sink::ApplicationDomain::BufferAdaptor> EntityReaderUtils::getPrevious(const Sink::Storage::DataStore::NamedDatabase &db, const QByteArray &uid, qint64 revision, DomainTypeAdaptorFactoryInterface &adaptorFactory, qint64 &retrievedRevision) */
/* { */
/*     QSharedPointer<Sink::ApplicationDomain::BufferAdaptor> current; */
/*     qint64 latestRevision = 0; */
/*     db.scan(uid, */
/*         [&current, &latestRevision, revision](const QByteArray &key, const QByteArray &) -> bool { */
/*             auto foundRevision = Sink::Storage::DataStore::revisionFromKey(key); */
...
/*     return get(db, Sink::Storage::DataStore::assembleKey(uid, latestRevision), adaptorFactory, retrievedRevision); */
/* } */

/* template <class DomainType> */
/* EntityReader<DomainType>::EntityReader(const QByteArray &resourceType, const QByteArray &resourceInstanceIdentifier, Sink::Storage::DataStore::Transaction &transaction) */
...
/* template <class DomainType> */
/* EntityReader<DomainType>::EntityReader(DomainTypeAdaptorFactoryInterface &domainTypeAdaptorFactory, const QByteArray &resourceInstanceIdentifier, Sink::Storage::DataStore::Transaction &transaction) */
/*     : mResourceInstanceIdentifier(resourceInstanceIdentifier), */
/*     mTransaction(transaction), */
...
template <class DomainType>
EntityReader<DomainType>::EntityReader(Storage::EntityStore &entityStore)
...
DomainType EntityReader<DomainType>::read(const QByteArray &identifier) const
{
    ...
    return mEntityStore.readLatest<DomainType>(identifier);
}
...
{
    /* auto typeName = ApplicationDomain::getTypeName<DomainType>(); */
    /* auto mainDatabase = Storage::DataStore::mainDatabase(mTransaction, typeName); */
...
QPair<qint64, qint64> EntityReader<DomainType>::executeInitialQuery(const Sink::Query &query, int offset, int batchsize, const ResultCallback &callback)
{
    ...
    auto preparedQuery = ApplicationDomain::TypeImplementation<DomainType>::prepareQuery(query, Storage::EntityStore::Ptr(&mEntityStore, [](Storage::EntityStore *){}));
    ...
    return qMakePair(mEntityStore.maxRevision(), replayedEntities);
}
...
qint64 EntityReader<DomainType>::replaySet(ResultSet &resultSet, int offset, int batchSize, const ResultCallback &callback)
{
    ...
    /*             Q_ASSERT(adaptor); */
    /*             return callback(QSharedPointer<DomainType>::create(mResourceContext, result.uid, result.buffer.revision(), adaptor), result.operation, result.aggregateValues); */
    /*         }); */
    /*     if (!ret) { */
    /*         break; */
    /*     } */
