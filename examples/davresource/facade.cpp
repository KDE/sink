...
DavResourceContactFacade::DavResourceContactFacade(const Sink::ResourceContext &context)
    : Sink::GenericFacade<Sink::ApplicationDomain::Contact>(context)
{
}

DavResourceContactFacade::~DavResourceContactFacade()
{
}
